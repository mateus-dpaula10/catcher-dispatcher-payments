...
return new class extends Migration
{
    ...
    {
        Schema::create('dados_susan_pet_rescues', function (Blueprint $table) {
            $table->id();

            $table->string('external_id')->nullable()->unique();
            $table->unsignedBigInteger('give_payment_id')->nullable()->index(); 
            $table->string('transaction_id')->nullable()->index();              
            $table->string('currency', 10)->nullable();  
            $table->string('give_form_id')->nullable()->index(); 
    ...
    {
        Schema::dropIfExists('dados_susan_pet_rescues');
    }
};
